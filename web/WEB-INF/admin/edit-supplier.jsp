...
<html>
    ...
    <body>
                        ...
                        <div class="admin-main-content-container">
                            ...
                            <div class="admin-main-content-body">
                                <div class="container admin-main-content-body-form">
                                    <form class="admin-main-content-body-form edit-supplier" action="supplier?action=edit-supplier" method="post">
                                        <input type="text" name="id" value="${requestScope.supplier.id}" hidden>
                                        <div class="admin-main-content-body-group">
                                            <label>Supplier name</label>
                                            <input type="text" name="suppliername" required value="${requestScope.supplier.name}">
                                            <span class="message admin-main-content-body-group-error"></span>
                                        </div>
                                        <div class="admin-main-content-body-group">
                                            <label>Contact name</label>
                                            <input type="text" name="contactname" required value="${requestScope.supplier.contactName}">
                                            <span class="message admin-main-content-body-group-error"></span>
                                        </div>
                                        <div class="admin-main-content-body-group">
                                            <label>Phone</label>
                                            <input type="number" name="phone" required value="${requestScope.supplier.phone}">
                                            <span class="message admin-main-content-body-group-error"></span>
                                        </div>
                                        <div class="admin-main-content-body-group">
                                            <label>Email</label>
                                            <input type="email" name="email" required value="${requestScope.supplier.email}">
                                            <span class="message admin-main-content-body-group-error"></span>
                                        </div>
                                        <div class="admin-main-content-body-group">
                                            <label>Address</label>
                                            <input type="address" name="address" required value="${requestScope.supplier.address}">
                                            <span class="message admin-main-content-body-group-error"></span>
                                        </div>
                                        <div class="admin-main-content-body-form-control">
                                            ...
                                            <button onclick="handelSupplier(event, 'edit-supplier')" class="bttn" type="submit">
                                                <span>Edit</span>
                                            </button>
                                        </div>
                                    </form>
        ...
        <!-- box modal start -->
        <div class="modall box-modal edit-supplier-success">
            <div class="box-modal-container">
                <i class="box-icon fa-solid fa-circle-check"></i>
                <h3>Success</h3>
                <p>Edit supplier width id ${requestScope.supplier.id} successfully.</p>
