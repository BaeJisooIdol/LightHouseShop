                    ...
                    <section class="admin-main-content col-lg-10 col-md-9">
                        <div class="admin-main-content-container">
                            <div class="admin-main-content-header">
                                <div class="container">
                                    <div class="row">
                                        <h1 class="col-lg-6 col-md-6">Revenue By Month</h1>
                                        <div class="revenueByMonth col-lg-6 col-md-6">
                                            <select onchange="drawChart(this.value, 'month')">
                                                <option>2024</option>
                                                <option>2025</option>
                                                <option>2026</option>
                                            </select>
